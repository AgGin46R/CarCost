...
class ReceiptScannerService(private val context: Context) {
    ...
    /**
     * Названия сетей АЗС берутся из общего справочника.
     *
     * Раньше список жил здесь, а подсчёт цен по заправкам сводил написания
     * своим способом — две копии разошлись бы при первом же добавлении сети.
     */
    private val knownStations = com.aggin.carcost.data.reference.FuelStations.brands
