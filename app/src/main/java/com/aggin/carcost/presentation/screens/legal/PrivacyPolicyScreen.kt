...
fun PrivacyPolicyScreen(navController: NavController) {
    Scaffold(
        ...
        Column(
            ...
            Text(
                text = "Дата последнего обновления: 20 августа 2026 года",
            ...
            Text(
                text = "Приложение CarCost помогает вести учёт расходов на транспорт — автомобили " +
                    "и мотоциклы. " +
...
private val PRIVACY_SECTIONS: List<Pair<String, String>> = listOf(
    ...
    "Данные о транспорте" to
        "Вид техники (автомобиль или мотоцикл), марка, модель, год выпуска, " +
        "государственный регистрационный номер, VIN, цвет, пробег, дата и цена " +
        "покупки, фотография.",

    "Расходы" to
        "Суммы, даты, категории, описания, названия автозаправок и автосервисов, " +
        "объём топлива и киловатт-часы при зарядке, показания одометра, " +
        "фотографии чеков.",
    ...
    "Совместное использование" to
        "Если вы пригласили других людей к своему транспорту, они видят его данные " +
        "и расходы, а вы — их записи. Сообщения и файлы во внутреннем чате доступны " +
        "всем участникам.\n\n" +
        "Участники одной машины видят имя и фотографию профиля друг друга — это " +
        "нужно, чтобы в чате и в разбивке расходов было понятно, кто есть кто. " +
        "Посторонним ваш профиль не виден.\n\n" +
        "Приглашение можно отозвать в разделе «Участники»: после этого доступ к " +
        "записям прекращается.",
